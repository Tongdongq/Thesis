...
This version can output average read lengths of 10000-20000 bases, and its longest reads can exceed 60000 bases \cite{pacbio_readlength}.
...
\lstinputlisting[caption=Basic radix sort, label=code:radix1]{\codePath radix1.c}
...
\lstinputlisting[caption=Radix sort in Daligner, label=code:radix2]{\codePath radix2.c}
...
\todo{remove argument that width of wave is constant}
...
On an FPGA, Darwin has a 183.0x speedup for reference-guided and 19.9x speedup for de novo over state-of-the-art software.
\todo{19.9x based on first paper}
