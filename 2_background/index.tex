...
DNA alignment involves determining the similarity between two DNA reads, often with the intend to find an overlapping region.
...
Figure \ref{fig:dna_assembly} shows the process.
...
Another problem are repeat regions, %TODO: citation, finish sentence ('which are common in mammalian genomes')
...
This problem can be described as finding a Hamiltonina path \cite{Hamiltonian}, which is also an NP-hard problem \cite{ngs_difficulties}.
