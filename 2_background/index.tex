...
The newest pyrosequencing machines can produce read lengths up to 700 basepairs.
...
Another advantage is that it produces some of the longest read lengths in the industry, with an average of 10000 basepairs, and longest reads of 60000 basepairs \cite{pacbio_readlength}, Figure \ref{fig:pacbio_readlength} shows a distribution of the read lengths.
