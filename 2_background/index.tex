...
Figure \ref{fig:dna_replications2} shows XXXXXXXXXXXXXXXXX

\figC{width=\textwidth}{dna-replication.png}{DNA replication, source \cite{dna_replication_fig2}}{fig:dna_replication2}
...
Figure \ref{fig_nanopore_tunnel} shows the two different methods.
...
\figC{width=.6\textwidth}{nanopore_tunnel.jpg}{(a) a traditional nanopore measuring the ionic current in the direction of the ssDNA strand, (b) a tunnelling nanopore measuring the tunnelling current perpendicular to the ssDNA strand, source: \cite{nanopore_tunnel1}}{fig:nanopore_tunnel}
