...
There are three possible alignments with the highest score (4), small letters denote bases that do not appear in the overlap:

\begin{verbatim}
                    cATCGa       cATCG-A      cATC-GA
                     ||||    or   |||| |  or   ||| ||
                     ATCGga       ATCGGA       ATCGGA
\end{verbatim}
