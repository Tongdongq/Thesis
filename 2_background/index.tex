...
Probably the most used TGS platform is the Single Molecule RealTime (SMRT) sequencing platform from Pacific Biosciences.
A very important part of SMRT sequencing is the Zero-Mode Waveguide (ZMW) technology.
A ZMW is a very tiny well, with a diameter of 60-100 nm, and a height of 100 nm \cite{zmw}.
The metal that the wells are created in is placed on a glass substrate.
...
There are other nucleotides floating in the well, but the nucleotides held by the polymerase is illuminated approximately three orders of magnitude longer.
This creates a high signal-to-noise ratio \cite{window_tgs}.
...
\figC{scale=.5}{pacbio_readlength.jpeg}{A distribution of read lengths, from a human library, source: \cite{pacbio_readlength}}{fig:pacbio_readlength}
