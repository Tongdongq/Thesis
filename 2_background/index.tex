...
Creating new proteins from DNA is done via messenger RNA or \textit{mRTA}, which looks like DNA, but has only one strand.
...
The RNA strand will look like the \textit{coding (or sense) strand} of the DNA, the other DNA strand is called the \textit{template (or antisense) strand}.
...
The polymerase now adds RNA nucleotides to the template strand, creating an RNA strand.
