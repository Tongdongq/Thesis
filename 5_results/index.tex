...
\begin{table}
\centering
\caption{Runtimes for different Daligner parameters, one CPU thread, run on ce-cuda, 10x E.coli, de novo. Sensitivity and specificity are measured for A vs A, using a score threshold of 200.}
\label{tbl:daligner5}
...
\begin{tabular}{c c c}
optimizations & global load efficiency \\ \hline
baseline & 12\% \\
GLOBAL & 49\% \\
GLOBAL CPBASES & 73\% \\
CPBASES & 45\% \\
